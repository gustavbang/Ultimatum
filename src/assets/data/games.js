export const postlist = [
    ...
    {id: 'alle_spiller', img: 'eye_contact', title: 'ALLE SPILLER', subtitle: 'Medusa', content: 'Alle deltagere lægger panden i bordet. ' + "Maria" + ' tæller ned fra 3 til nu, hvorefter alle deltagere skal kigge en anden deltager i øjnene. Alle deltagere der har øjenkontakt med nogen, bunder ud'},
    {id: 'challenge', img: 'beer', title: 'CHALLENGE', subtitle: 'Spotify challenge', content: "Paloma" + ' er nu nynnemaster og den eneste der må se på telefonen.'},
    ...
    {id: 'challenge', img: 'beer', title: 'CHALLENGE', subtitle: 'Drik for helvede', content: "Maria" + ' skal drikke 5 tåre.'},
    ...
    {id: 'challenge', img: 'camera', title: 'CHALLENGE', subtitle: 'Flash', content: "Paloma" + ' vis dine venner hvor sjovt I har det! Du skal gå live på Facebook eller Instagram i minimum 5 min. eller bælle en hel øl.'},
    {id: 'challenge', img: 'closed_eyes', title: 'CHALLENGE', subtitle: 'Luk og smil', content: "Maria" + ' du skal have lukkede øjne og smile stort med tænderne, hver gang du taler til en anden deltager. Glemmer du det og bliver det påpeget, skal du drikke 3 tåre.'},
    //{id: 'challenge', img: 'twerk', title: 'CHALLENGE', subtitle: 'Twerk it like Miley', content: "Paloma" + ' du ligner en der er ved at falde i søvn. Vi skal vidst lige have rystet lidt gang i dine hofter… Vis os dine bedste twerk skills eller tag 5 tåre'},
    {id: 'challenge', img: 'tongue', title: 'CHALLENGE', subtitle: 'Slik', content: "Maria" + ' du skal slikke dig om munden hvergang nogen får øjenkontakt med dig. Glemmer du det straffes det med 3 tåre. Du må stoppe om fem spørgsmål.'},
    {id: 'challenge', img: 'beer', title: 'CHALLENGE', subtitle: 'Tale!', content: "Paloma" + ', Hold en tale om hvor meget du værdsætter dem omkring dig. Du SKAL benytte alle 5 ord: slikdåse, lommetørklæde, javertus, kronhjort og sovs. Talen skal minimum vare 45 sek. og du må ikke holde lange kunstige pauser. Hvis du ikke holder talen kørende, tiden ud, eller hvis du glemmer et eller flere ord drikker du 5 tåre!'},
    {id: 'challenge', img: 'tongue', title: 'CHALLENGE', subtitle: 'LipSync', content: '“Så er det tid til at slå fast hvem festens bedste Britney er - spiller med telefonen udfordrer ' + "Maria" + ' til en omgang lip sync! Taberen drikker X antal slurke. Player 2 du er dommer.” (Skriv info)'},
    {id: 'challenge', img: 'hand', title: 'CHALLENGE', subtitle: 'Klap', content: "Paloma" + ' klap højt hver gang nogen kommer med en god pointe'},
    //{id: 'challenge', img: 'twerk', title: 'CHALLENGE', subtitle: 'Shake that ass!', content: "Maria" + ' Lad os se hvor løse de hofter er, skriv dit navn i luften... ...med numsen! '},
