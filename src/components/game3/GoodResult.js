                ...
                <Grid container direction={"column"} alignItems={"center"} justify={"center"} style={{height: '80vh', width: '50%'}}>
                    ...
                    <Grid direction={"row"} style={{border: '6px solid #FE6347'}}>
                        <Link to={"/"} style={{textDecoration: 'none'}} >
                            <Typography style={{color: 'white', fontSize: '3em', fontFamily: 'Bitter', fontWeight: '700', margin: '20px'}}>Fedt spil? Subscribe og vær klar til den fulde version</Typography>
                        </Link>
                    </Grid>
                </Grid>
            </Grid>
