        ...
        return (
            <Grid container style={{width: '100%'}}>
                ...
                <Grid container direction={"column"} alignItems={"center"} justify={"center"}>
                    <Typography style={{color: 'black', fontSize: '2em', fontFamily: 'Bitter', fontWeight: '700', marginBottom: '10px', marginTop: '25px'}}>Du er en stjerne</Typography>
                    <Typography style={{color: 'black', fontSize: '1.0em', fontFamily: 'Bitter', fontWeight: '500', margin: '10px'}}>Giv 5 tåre</Typography>
